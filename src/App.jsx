...
import Premamkadhal from "./playlist/premamxkadhal";
import Anytimehit from "./playlist/anytimehit";
import Feelgoodplaylists from "./playlist/feelgoodplaylist";
import Tamilroadtrips from "./playlist/tamilroadtrips";
import Lonelyhits from "./playlist/lonelyhits";
import Malayalam from "./playlist/malayalamsongs";
        ...
        <div className="w-full h-full flex gap-1">
          ...
          <div className="main3 relative rounded-lg  overflow-hidden w-screen h-screen overflow-y-auto ml-[5px] ">
            <Routes>
              ...
              <Route path="/m1" element={token &&<Premamkadhal />} />
              <Route path="/m2" element={token &&<Feelgoodplaylists/>} />
              <Route path="/m3" element={token &&<Anytimehit />} />
              <Route path="/m4" element={token &&<Lonelyhits/>} />
              <Route path="/m5" element={token &&<Tamilroadtrips />} />
              <Route path="/m6" element={token &&< Malayalam/>} />
