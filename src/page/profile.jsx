                    ...
                    <>
                        ...
                        <div className='bg-zinc-900'>
                            <div className='px-10 p-10'>
                                <p className='text-3xl text-white font-bold mb-2'>Top artists this month</p>
                                <p className='text-stone-500 font-semibold mb-2'>Only visible to you</p>
                            ...
                            <div className='px-10 p-10 mb-20'>
                            <p className='text-2xl text-white font-bold'>Following</p>
                            <div className='desktop:grid-cols-5 laptops:grid-cols-5 tablets:grid-cols-4 grid mobiles:grid-cols-1 py-2 gap-7'>
                            <div className='py-4 px-2 h-68 w-44 bg-zinc-800 rounded'>
                                    <img src="https://i.scdn.co/image/56be4a74de1766bf473f6271235de296e4878d41" className='rounded-full w-52'/>
                                    <br></br>
                                    <p className='text-white'>Udit Narayanan</p>
                                    <p className='text-stone-500'>Artist</p>
